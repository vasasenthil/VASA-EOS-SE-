...
Six engines on vLLM/Triton with model cards + drift. Reference DETERMINISTIC engines exist (lib/ai/engines) — they are advisory analogues, NOT the LLM serving stack the spec requires.
