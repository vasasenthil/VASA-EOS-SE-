...
export const ASSURANCE_REGISTER: AssuranceItem[] = [
  ...
  { id: "license", name: "OSS license compliance", category: "security", standard: "SPDX / OSS policy", owner: "Engineering + Legal", cadence: "Every push (CI)", status: "passed", evidence: "scripts/license-check.mjs — 60 deps, 0 denied" },
