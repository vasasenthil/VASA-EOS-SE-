...
export const BROCHURE_CLAIMS: BrochureClaim[] = [
  ...
  { id: "languages", area: "Experience & access", claim: "22 Indian languages", status: "partial", note: "i18n scaffolding lists the languages; full translation coverage across all routes is not complete", repoRef: "lib/i18n/languages.ts" },
