...
export const SECRETARY_CAPABILITIES: SecretaryCapability[] = [
  ...
  { id: "recognition-oversight", dimension: "functional", responsibility: "School recognition / approvals oversight", featureRef: "lib/recognition/oversight.ts", route: "/governance/recognition-oversight", status: "built" },
  { id: "cadre-postings", dimension: "functional", responsibility: "Cadre management & transfer-posting policy at scale", featureRef: "lib/postings/cadre.ts", route: "/governance/cadre-rationalisation", status: "built" },
