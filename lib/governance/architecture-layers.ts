...
export const ARCHITECTURE_LAYERS: ArchitectureLayer[] = [
  ...
  },
  {
    ...
    status: "partial",
    note:
      "13 portals and the design system are built across the route estate. WCAG 2.1 A/AA is met by automated audit and the design system. Multilingual is real, type-safe code-first AND TMS-ready, and now WIRED INTO THE LIVE SHELL: an app-wide language switcher in the header plus a Tamil-first sidebar (mapped nav titles translate, others fall back to English). A typed MessageKey set (English-complete at compile time, no orphan keys, typo-proof call sites) backs a measured UI-string layer, with a Git-native TMS bridge (deterministic JSON export + import-validation gate) — sovereign, no cloud SaaS. Tamil/English/Hindi complete; Telugu/Malayalam/Kannada/Urdu partial with honest per-locale coverage at /accessibility/languages. AAA criteria needing assistive-tech/manual verification and full 22-language translation remain audit-required / partial.",
