...
| All interactive modules persisted | 🟡 | ~30 modules persist via stores (+ Vacancy, Textbooks, Eco-club); **~44 newer modules still hold state in the browser (`useState`)**. They follow the same converter — rolling out module-by-module |
