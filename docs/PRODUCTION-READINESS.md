...
| All interactive modules persisted | 🟡 | ~27 modules persist via stores (+ Science-fair, Fitness, Reading); **~47 newer modules still hold state in the browser (`useState`)**. They follow the same converter — rolling out module-by-module |
