...
| All interactive modules persisted | 🟡 | ~33 modules persist via stores (+ Guest-lectures, ICT-lab, Maintenance); **~41 modules still hold state in the browser (`useState`)**. They follow the same converter — rolling out module-by-module |
