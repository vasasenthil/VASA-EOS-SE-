...
| All interactive modules persisted | 🟡 | ~24 modules persist via stores (+ NSS/NCC, Assembly, Student-banking); **~50 newer modules still hold state in the browser (`useState`)**. They follow the same converter — rolling out module-by-module |
