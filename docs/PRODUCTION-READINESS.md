...
| All interactive modules persisted | 🟡 | ~21 modules persist via stores (+ Vocational, Student-council, Bagless); **~53 newer modules still hold state in the browser (`useState`)**. They follow the same converter — rolling out module-by-module |
