...
| Per-role data scoping (ReBAC) | ✅ (engine) / 🟡 (rollout) | `lib/access/scope` + `scope-server` + `/governance/scope`; **wired on 29 modules**: safety, discipline, cwsn, lost-found, cooks, rte, rti, oosc, water, cctv, drills, competitions, excursions, tc, visitors, circulation, alumni, distribution, certificates, stock, sciencefair, guest-lectures, council, assembly, eco-club, nss-ncc, student-banking, fitness, reading. Remaining store-backed modules pending |
