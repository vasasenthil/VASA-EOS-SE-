...
Generated: 2026-09-25T10:21:17.799Z

## Acceptance sections

| ID | Section | Status | Owner | Evidence |
| --- | --- | --- | --- | --- |
| inventory-ledger | Machine inventory ledger | pass | Governance Secretariat | 1427 artefacts inventoried; 476 routes; 123 APIs |
...
| api | `app/api/admin/platform-configuration/[id]/activate/route.ts` | built | Module Owner | internal | yes |
| api | `app/api/admin/platform-configuration/[id]/decision/route.ts` | built | Module Owner | internal | yes |
| api | `app/api/admin/platform-configuration/[id]/rollback/route.ts` | built | Module Owner | internal | yes |
| api | `app/api/admin/platform-configuration/route.ts` | built | Module Owner | internal | yes |
...
| api | `app/api/governance/functional-coverage/csv/route.ts` | built | Governance Secretariat | confidential | yes |
| api | `app/api/governance/functional-coverage/route.ts` | built | Governance Secretariat | confidential | yes |
...
| api | `app/api/governance/readiness-ledger/csv/route.ts` | built | Governance Secretariat | confidential | yes |
| api | `app/api/governance/readiness-ledger/route.ts` | built | Governance Secretariat | confidential | yes |
...
| api | `app/api/production/policies/readiness/route.ts` | built | Sovereign Ops | confidential | yes |
...
| api | `app/api/secretary/command-centre/report/route.ts` | built | Module Owner | internal | yes |
| api | `app/api/seed/route.ts` | partial | Module Owner | internal | yes |
| api | `app/api/traces/route.ts` | built | Module Owner | internal | yes |
| api | `app/api/workflows/[id]/decision/route.ts` | built | Module Owner | internal | yes |
